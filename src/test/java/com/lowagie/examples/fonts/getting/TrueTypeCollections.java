...
public class TrueTypeCollections {
	...
	public static void main(String[] args) {
        ...
        try {
			BufferedWriter out = new BufferedWriter(new FileWriter(RunAllExamplesTest.OUTPUT_DIR + "msgothic.txt"));
            ...
            PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "truetypecollections.pdf"));
