...
public class Concatenate {
	...
	public void test() throws Exception {
		main(PdfTestBase.RESOURCES_DIR + "HelloWorldMeta.pdf", PdfTestBase.RESOURCES_DIR + "ChapterSection.pdf",
				"Concatenate.pdf");
	}
	...
	public void main(String... args) throws Exception {
		...
		while (f < args.length - 1) {
			...
			if (f == 0) {
				...
				writer = new PdfCopy(document, PdfTestBase.getOutputStream(outFile));
