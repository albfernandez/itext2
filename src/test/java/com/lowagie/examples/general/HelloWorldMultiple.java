	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter pdf = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "HelloWorldPdf.pdf"));
			RtfWriter2 rtf = RtfWriter2.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "HelloWorldRtf.rtf"));
			HtmlWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "HelloWorldHtml.html"));
