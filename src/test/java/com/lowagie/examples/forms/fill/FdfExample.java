...
public class FdfExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            fdf.writeTo(new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "SimpleRegistrationForm.fdf"));

            // merging the FDF file
            PdfReader pdfreader = new PdfReader(RunAllExamplesTest.RESOURCES_DIR + "SimpleRegistrationForm.pdf");
            PdfStamper stamp = new PdfStamper(pdfreader, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "registered_fdf.pdf"));
