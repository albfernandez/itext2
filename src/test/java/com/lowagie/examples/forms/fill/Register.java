...
public class Register {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // filling in the form
            PdfStamper stamp1 = new PdfStamper(reader, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "registered.pdf"));
            ...
            PdfStamper stamp2 = new PdfStamper(reader, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "registered_flat.pdf"));
