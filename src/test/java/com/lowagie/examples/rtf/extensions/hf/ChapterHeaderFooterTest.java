...
/**
 * The ChapterHeaderFooter example shows how by using Chapters it is possible to
 * have different headers and footers for different parts of the document.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 */
public class ChapterHeaderFooterTest {
	/**
