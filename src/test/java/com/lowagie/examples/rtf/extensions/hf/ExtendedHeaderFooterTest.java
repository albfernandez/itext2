...
/**
 * The ExtendedHeaderFooter example demonstrates the use of the RtfHeaderFooter
 * object to create more complex headers or footers using more complex elements
 * such as multiple paragraphs or tables.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 */
public class ExtendedHeaderFooterTest {
	/**
