...
/**
 * The ExtendedFont example demonstrates using the RtfFont class to generate RTF
 * documents with fonts other than the core iText fonts.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 * @see com.lowagie.text.rtf.style.RtfFont
 */
public class ExtendedFontTest {
	/**
