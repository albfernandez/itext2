...
/**
 * The DrawingFreeform example demonstrates creating freeform drawing objects
 * using an array of Point objects. The example creates a table shaped drawing
 * object.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 */
public class DrawingFreeformTest {
	/**
