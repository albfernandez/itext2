...
/**
 * The ExtendingStylesheets example shows how to create new paragraph
 * stylesheets that (if desired) inherit from existing stylesheets.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 */
public class ExtendingStylesheetsTest {
	/**
