...
/**
 * The DrawingAnchor example demonstrates how a drawing object can be anchored
 * to a Paragraph and the page margin, instead of the page to create a
 * horizontal line.
 * 
 * @version $Revision: 3373 $
 * @author Mark Hall (Mark.Hall@mail.room3b.eu)
 */
public class DrawingAnchorTest {
	/**
