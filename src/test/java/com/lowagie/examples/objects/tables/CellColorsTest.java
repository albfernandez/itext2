...
/**
 * The Cell is derived from the Rectangle object, so we can do all kinds of
 * things with the borders and colors.
 */
public class CellColorsTest {
	...
	public void main() throws Exception {
		...
		// step2
		PdfWriter.getInstance(document, PdfTestBase.getOutputStream("CellColors.pdf"));
		// step3
		document.open();
		// step4
