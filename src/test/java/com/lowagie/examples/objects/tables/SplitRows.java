	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter.getInstance(document1,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "SplitRowsBetween.pdf"));
			PdfWriter.getInstance(document2,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "SplitRowsWithin.pdf"));
			PdfWriter.getInstance(document3,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "OmitRows.pdf"));
			// step3
			document1.open();
			document2.open();
			document3.open();
