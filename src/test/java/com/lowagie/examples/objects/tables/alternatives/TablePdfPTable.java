...
public class TablePdfPTable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "tableattributes.pdf"));
            RtfWriter2.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "tableattributes.rtf"));
            // open the document
            document.open();
            // add content
