	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer1 = PdfWriter.getInstance(document1,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "SimpleAnnotations1.pdf"));
			PdfWriter writer2 = PdfWriter.getInstance(document2,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "SimpleAnnotations2.pdf"));
			// step 3:
            ...
            document1.add(a3);
			Image image = Image.getInstance(RunAllExamplesTest.RESOURCES_DIR + "iText.gif");
