...
public class RemoteGoto {
	 ...
	 */    public static void main(String[] args) {
        ...
        try {
            ...
            // step 2:
            PdfWriter writerA = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "DocumentA.pdf"));
            PdfWriter writerB = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "DocumentB.pdf"));
