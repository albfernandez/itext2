...
public class AHref {
	...
	public static void main(String[] args) {
		...
		try {
            // step 2:
            PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "AHref.pdf"));
            HtmlWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "AHref.html"));
