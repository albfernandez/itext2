	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "Annotations.pdf"));
			// step 3:
			...
			// page 1
            PdfFileSpecification fs = PdfFileSpecification.fileExtern(writer, RunAllExamplesTest.RESOURCES_DIR +"cards.mpg");
