...
public class OutlineActions {
	...
	public static void main(String[] args) {
		...
		try {
            // step 2:
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "OutlineActions.pdf"));
            PdfWriter.getInstance(remote, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "remote.pdf"));
            // step 3:
