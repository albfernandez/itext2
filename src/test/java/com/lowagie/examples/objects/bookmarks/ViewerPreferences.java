	...
	public static void main(String[] args) {
		...
		try {
			...
			PdfWriter writer1 = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "TwoColumnLeft.pdf"));
			PdfWriter writer2 = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "HideMenuToolbar.pdf"));
			PdfWriter writer3 = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "FullScreen.pdf"));
			PdfWriter writer4 = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "WithTitle.pdf"));
			PdfWriter writer5 = PdfWriter.getInstance(document,
					new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "NoScaling.pdf"));
			// step 3:
