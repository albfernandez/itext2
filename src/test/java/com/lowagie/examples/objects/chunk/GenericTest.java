...
public class GenericTest extends PdfPageEventHelper {
	/**
	...
	public void main() throws Exception {
		...
		PdfWriter writer = PdfWriter.getInstance(document, PdfTestBase.getOutputStream("Generic.pdf"));
		writer.setPageEvent(new GenericTest());
