...
public class SplitCharTest implements SplitCharacter {
	...
	public void main() throws Exception {
		...
		PdfWriter.getInstance(document, PdfTestBase.getOutputStream("SplitChar.pdf"));
		...
		chunk = new Chunk(text, font);
		chunk.setSplitCharacter(new SplitCharTest());
		p = new Paragraph(24, chunk);
		document.add(p);
