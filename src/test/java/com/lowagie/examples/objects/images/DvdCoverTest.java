...
public class DvdCoverTest {
	...
	/**
	 * Sets the title of the movie (will be printed on the side if there is no
	 * side image)
	 * 
	 * @param title
	 *            The title to set.
	...
	public void test() throws Exception {
		main(PdfTestBase.OUTPUT_DIR + "dvdcover.pdf", "My Sunflower Movie", "808080", PdfTestBase.RESOURCES_DIR
				+ "sunflower-front.jpg", PdfTestBase.RESOURCES_DIR + "sunflower-back.jpg");
	}
	 ...
	 * 
	 * @param args
	 *            an array containing [0] a filename [1] a title [2] a
	 *            backgroundcolor [3] a front image [4] a back image [5] a side
	 *            image
	 */
	public void main(String... args) throws Exception {
		DvdCoverTest cover = new DvdCoverTest();
		if (args.length > 0) {
