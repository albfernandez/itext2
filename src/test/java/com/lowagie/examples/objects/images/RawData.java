...
public class RawData {    
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "rawdata.pdf"));
            ...
            RandomAccessFile rf = new RandomAccessFile(RunAllExamplesTest.RESOURCES_DIR +"otsoe.jpg", "r");
