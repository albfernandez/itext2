...
public class ImageMasks {
    ...
    public static void main(String[] args) {
        ...
        try {
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "maskedImages.pdf"));
            ...
            Image image = Image.getInstance(RunAllExamplesTest.RESOURCES_DIR +"otsoe.jpg");
