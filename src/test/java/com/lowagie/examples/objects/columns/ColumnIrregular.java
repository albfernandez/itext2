...
public class ColumnIrregular {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "columnirregular.pdf"));
            ...
            Image caesar = Image.getInstance(RunAllExamplesTest.RESOURCES_DIR +"caesar_coin.jpg");
