 ...
 */
public class ColumnObjectsTest {
	...
	public void main() throws Exception {
        ...
        Document document = new Document(PageSize.LETTER, 90, 54, 72, 72);
            ...
            PdfWriter writer = PdfWriter.getInstance(document, PdfTestBase.getOutputStream( "columnobjects.pdf"));
            ...
            cb.stroke();
            Image img = Image.getInstance(PdfTestBase.RESOURCES_DIR +"cover.png");
