...
public class ColumnObjects {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "columnobjects.pdf"));
            ...
            cb.stroke();
            Image img = Image.getInstance(RunAllExamplesTest.RESOURCES_DIR +"cover.png");
