...
public class Lists {
	...
	public static void main(String[] args) {
		...
		try {
            // step 2:
            PdfWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "lists.pdf"));
            HtmlWriter.getInstance(document, new FileOutputStream(RunAllExamplesTest.OUTPUT_DIR + "lists.html"));
